...
---
把模型跟人放一起：
- 一個沒有geometry的body會有交互作用力嗎(不會，看掉到地上就知道了)(最佳)
- 直接用joint相連，需要新的模型
- EXO放上去了人會跌倒，所以需要重新學習走路(重量太重)(已解決)

---

mass: 主體2 -> 0.5, 擺臂0.5->0.1，因為純SCONE的方法所設計的走路模型不夠穩，只是剛好可以走而已。
- 要怎麼讓模型先靜止不動(不用，改成用外骨骼)

---
我應該要重疊對標硬體(不，因為成本壓不下來)\
選擇始祖鳥，一開始就要提到competitor\
找兩種
- 登山端 -> 醫療端(一路進到)
