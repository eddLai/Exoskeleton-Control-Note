...
### 總任務列表：
- [x] 怎麼調用.exe以及dll這些不能使用的，改用純python code，沈恩佑
...
- KV260環境設定
	- [x] 模型遷入KV260
	- [x] KV260載體以及與EXO的連接
- [x] 更合理的reward定義，跟著模擬串接的時候做
- 模擬端訓練：[[human exo simulation environment development schedule]], 之前紀錄https://github.com/sk413025/sci-competition
	- [ ] gazebo simulator
	- [ ] scone
