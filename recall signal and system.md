...
$$\sum_{n=-\infty}^\infty x_0[m]\delta(k-m)=\sum_{n=-\infty}^\infty x_0[m]\delta(k-m-nN)$$
$$=\sum_{n=-\infty}^\infty x_0[m]\delta(k-m-nN)$$
...
$$=\sum_{n=-\infty}^\infty\delta(k-nN)\sum_{k=-\infty}^\infty\delta(k-nN)$$