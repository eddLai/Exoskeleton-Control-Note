...
>multiplied by the **Hamming window**. The window size was **512 ms**. The sam pling interval in the time domain was 75% of the window length. The average value of median frequency in each short-time segment was used as a fatigue index of mus cles in each walking condition.
